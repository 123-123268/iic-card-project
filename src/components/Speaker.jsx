...
const Speaker = () => {
    const speakers=[{name:"Aman Dhattarwal",date:"15 sept 2023", desc:"Educationist & Co-founder of Apna College",image:"Aman_dhattarwal.png",id:1},{name:"Ankush Singla",date:"12 oct 2023",desc:"Co-founder & CEO of Coding Ninja",image:"ankush.png",id:2},{name:"Pratik Narang" ,date:"12 sept 2023",desc:"Co-founder of Coding Minutes",image:"pratik.png",id:3},{name:"Samrat Shegal" ,date:"12 sept 2023",desc:"Head of Supply Chain and procurement- Dabur India",image:"samrat.png" ,id:4},{name:"Dr. Abhas Mitra",date:"12 sept 2023",desc:"Indian Astrophysicist - pioneering big band theory and black holes",image:"abhas_mitra.jpg",id:5},{name:"VK Raizada",date:"12 sept 2023",desc:"Executive Director-Indian Oil Corporation Limited",image:"vk_raizada.jpg",id:6},{name:"Anil Kumar Aggrawal",date:"12th sept 2023",desc:"Scientist- G and Director ER & IPR at DRDO Headquaters",image:"anil_kumar.jpg",id:7}]
    
  return (
    <div className='bg-black min-h-screen w-full m-0 '>
      <div className='text-5xl text-pink-500 text-center'>SPEAKERS</div>
      <div className='mt-10 flex carousel w-full md:w-1/2 lg:w-1/2 mx-auto'>
        {speakers.map(item=>{
           ...
           <div className=" bg-gradient-to-r from-purple-500 to-pink-500 w-58 md:w-62 lg:w-96 rounded-lg text-white flex-col mx-auto ">
